...
## Corpus Check
- 174 files · ~141,996 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1220 nodes · 2374 edges · 120 communities (94 shown, 26 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 156 edges (avg confidence: 0.55)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5b597fba`
...
Cohesion: 0.06
Nodes (48): print_invoice(), Stream a live PDF preview using the most recent invoice for this company., Generate a PDF on the fly using the submitted form data for a live preview., templates_delete(), templates_edit(), templates_index(), templates_live_preview(), templates_new() (+40 more)
...
Cohesion: 0.16
Nodes (36): Account, _active_ledger_conditions(), _compute_account_balance(), _compute_balances_bulk(), _expenses_by_account(), _is_receivable_account(), _ledger_manual_expenses_by_account(), _ledger_revenue_by_account() (+28 more)
...
Cohesion: 0.10
Nodes (14): List all document sequences for a company, Form to create a new document sequence, Store a new document sequence, Form to edit an existing document sequence, Update an existing document sequence, sequence_create(), sequence_edit(), sequence_store() (+6 more)
...
Cohesion: 0.22
Nodes (9): Contact Form, Product Form, Inventory Navigation, Purchase Order Detail, Cross Module Search, Global Search, Warehouse Form, Warehouse List (+1 more)
...
Cohesion: 0.15
Nodes (21): api_search(), api_adjust_stock(), api_bulk_delete(), api_create_item(), api_delete_item(), api_get_item(), api_stats(), api_update_item() (+13 more)
...
Cohesion: 0.12
Nodes (8): DocumentType, EmployeeClass, LeaveStatus, LeaveType, PayPeriod, PTOAccrualPeriod, StockMovementType, UserStatus
...
Cohesion: 0.22
Nodes (5): Project, str, _match_context(), _result(), _search_tokens()
...
Cohesion: 0.05
Nodes (26): int, str, post_invoice_payment_income(), Account, int, Return the preferred revenue account for invoice-payment income., Post a balanced income transaction for an invoice payment.      The transactio, Return the preferred cash/bank asset account for a company. (+18 more)
...
Cohesion: 0.16
Nodes (11): _create_balanced_transaction(), Double-entry Balance Rules, Create a Transaction + LedgerEntry rows atomically.     Raises ValueError if ent, Accounting integration helpers for invoice payments., Account, str, Accounts that normally carry a debit balance vs credit balance., Chart of Accounts entry.      IMPORTANT: Balance is NOT stored here — it is alwa (+3 more)
...
Cohesion: 0.21
Nodes (12): Account CRUD and chart of accounts generation., Account, datetime, float, int, AccountingService — complete double-entry bookkeeping service.  This module re-e, Main AccountingService facade.     Inherits all @staticmethod methods from the d, DashboardService (+4 more)

### Community 36 - "Community 36"
Cohesion: 0.25
Nodes (6): _active_expense_conditions(), Expense rows count only when unlinked or tied to a non-voided transaction., _recent_active_expenses(), Return full P&L breakdown for a project., float, int

### Community 37 - "Community 37"
Cohesion: 0.05
Nodes (37): Libro Diario, Transaction Void Delete Workflow, Libro Mayor, Project Financial Detail, Financial Reporting Workflow, Financial Reports, InventoryService, _item_ids_from_search_tag() (+29 more)
...
Cohesion: 0.08
Nodes (32): Flask, register_blueprints(), register_cli(), Flask, register_context_processors(), get_locale(), register_extensions(), Flask (+24 more)
...
Cohesion: 0.22
Nodes (7): create_employee(), Employee, bool, float, str, Prefer the linked user's name when available., Deduct *days* from pto_balance if balance is sufficient. Returns True on success

### Community 101 - "Community 101"
Cohesion: 0.20
Nodes (6): Company Model, str, Auto-generate a URL-safe slug from the company name., str, upgrade(), Company Timezone and Logo Migration
...
Cohesion: 0.20
Nodes (12): export(), view(), create(), delete(), index(), get_purchase_orders(), delete_purchase_order(), Soft-delete a purchase order. (+4 more)

### Community 110 - "Community 110"
Cohesion: 0.29
Nodes (5): store(), update(), create(), edit(), index()
...
Cohesion: 0.25
Nodes (5): create_account(), edit_account(), Journal entries, ledger, and trial balance service., AccountType, TransactionType
...
### Community 118 - ".is_balanced"
Cohesion: 0.10
Nodes (13): BaseModel, str, str, str, str, str, str, Report (+5 more)
...
- **Why does `datetime` connect `Accounting Module` to `Warehouses Migration`, `Core Models`, `Inventory & Orders Service`, `Community 35`, `Invoices Service`, `Community 5`, `Community 37`, `Inventory Routes`, `Auth Module`, `Detect Script`, `Barcode JS`, `Companies Routes`, `AccountType`, `Community 60`, `Models Update Migration`?**
  _High betweenness centrality (0.156) - this node is a cross-community bridge._
- **Why does `BaseModel` connect `.is_balanced` to `Warehouses Migration`, `Community 96`, `Community 35`, `Community 100`, `Community 101`, `HR Module`, `Community 37`, `Auth Module`, `Community 43`, `Warehouses Service`, `Community 93`, `Consolidate Schema Migration`, `Auto Migration`, `.total_amount`, `Initial Migration`, `Auto Migration 2`, `Community 60`, `Models Update Migration`?**
  _High betweenness centrality (0.097) - this node is a cross-community bridge._
- **Why does `Document` connect `Initial Migration` to `Warehouses Migration`, `Community 35`, `Accounting Module`, `Community 37`, `HR Module`, `Community 101`, `Detect Script`, `.is_balanced`, `Models Update Migration`?**
