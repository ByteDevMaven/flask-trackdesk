...
## Corpus Check
- 159 files · ~124,006 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1109 nodes · 2447 edges · 108 communities (92 shown, 16 thin omitted)
- Extraction: 87% EXTRACTED · 13% INFERRED · 0% AMBIGUOUS · INFERRED: 328 edges (avg confidence: 0.54)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2e1ef1f0`
...
Cohesion: 0.11
Nodes (40): chart_of_accounts(), _company_url_id(), create_account(), create_journal_entry(), create_project(), create_tag(), delete_account(), delete_expense() (+32 more)

### Community 2 - "Inventory & Orders Service"
Cohesion: 0.19
Nodes (22): bool, float, str, str, Company, ClientCoords, _draw_client_info(), _draw_header() (+14 more)
...
Cohesion: 0.14
Nodes (11): str, str, str, str, str, str, AuditLog, BaseModel (+3 more)
...
Cohesion: 0.18
Nodes (7): int, str, str, update_invoice_or_quote, StockMovementType, Return signed quantity: negative for outgoing, positive for incoming/adjustment., _company_tax_rate()
...
Cohesion: 0.11
Nodes (13): format_currency(), format_date(), index(), locale_date(), Format a number as currency, Format a date in a readable format, Format date according to the current locale, Flask (+5 more)
...
Cohesion: 0.11
Nodes (22): str, str, create_invoice_or_quote, _generate_document_number, add_invoice_payment, add_payment(), create(), delete() (+14 more)
...
Cohesion: 0.14
Nodes (16): float, str, create_schedule(), delete_employee(), delete_leave(), delete_schedule(), edit_leave(), edit_schedule() (+8 more)
...
Cohesion: 0.12
Nodes (19): Account, int, Account, datetime, float, int, int, float (+11 more)
...
Cohesion: 0.22
Nodes (11): int, str, Employee Editor Drawer, PTO Configuration, Employee Directory, Leave Request Form, create_leave(), leaves() (+3 more)
...
Cohesion: 0.17
Nodes (11): int, str, str, Company, Report, Project, _active_expense_conditions(), Expense rows count only when unlinked or tied to a non-voided transaction. (+3 more)
...
Cohesion: 0.28
Nodes (7): Flask, register_cli(), register_extensions(), Flask, register_request_hooks(), create_app(), register_routes()

### Community 44 - "Community 44"
Cohesion: 0.30
Nodes (6): str, BaseModel, create_purchase_order, update_purchase_order, _purchase_cost_from_form(), Use the submitted purchase cost, falling back to the item's cost price.
...
Cohesion: 0.24
Nodes (8): str, int, str, str, _allowed_file(), _save_attachment(), Auto-generate a SKU from the item name and its DB id.                  Example:, str
...
Cohesion: 0.40
Nodes (3): int, get_layout(), Retrieve the PdfTemplateLayout for the given company_id.
...
- **Why does `Flask` connect `Drawer UI JS` to `App Init & Middleware`, `Inventory & Orders Service`, `Invoices Service`, `Community 5`, `Inventory Routes`, `Auth Module`, `Barcode JS`, `Payments Module`, `Migrations Core`, `Order Form JS`, `Auto Migration`, `Initial Migration`, `Auto Migration 2`, `Models Update Migration`, `Audit Columns Migration`, `Accounting Migration`, `Login Migration`, `Tags Migration`, `Detect Script`, `Community 44`, `Community 60`, `Community 95`, `Community 96`, `Community 97`, `Community 99`?**
  _High betweenness centrality (0.116) - this node is a cross-community bridge._
- **Why does `BaseModel` connect `HR Module` to `Core Models`, `Inventory & Orders Service`, `Invoices Service`, `Auth Module`, `Warehouses Service`, `Consolidate Schema Migration`, `Order Form JS`, `Unify Contacts Migration`, `Auto Migration`, `Initial Migration`, `Audit Columns Migration`, `Warehouses Migration`, `Budget Migration`, `Accounting Migration`, `HR Migration`, `Tags Migration`, `Modals UI JS`, `Community 43`, `Community 44`, `Community 45`, `Community 50`, `Community 54`, `Community 98`?**
  _High betweenness centrality (0.083) - this node is a cross-community bridge._
- **Why does `resolve_company()` connect `Payments Module` to `Community 96`, `App Init & Middleware`, `Warehouses Migration`, `Login Migration`, `Barcode JS`, `Drawer UI JS`, `Order Form JS`, `Unify Contacts Migration`, `Initial Migration`?**
