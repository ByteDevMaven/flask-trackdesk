# Graph Report - flask-trackdesk  (2026-06-17)

## Corpus Check
- 164 files · ~128,635 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1132 nodes · 2489 edges · 117 communities (92 shown, 25 thin omitted)
- Extraction: 87% EXTRACTED · 13% INFERRED · 0% AMBIGUOUS · INFERRED: 317 edges (avg confidence: 0.53)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c02ab44e`
...
3. `Flask` - 54 edges
4. `AccountType` - 45 edges
5. `ProjectService` - 44 edges
6. `datetime` - 35 edges
7. `TransactionType` - 35 edges
8. `Document` - 32 edges
9. `Company` - 27 edges
10. `_is_ajax()` - 22 edges
...
Cohesion: 0.18
Nodes (15): int, str, Transaction, _get_period_bounds(), Return (start_dt, end_dt) as naive datetimes for the given period., JournalService, _parse_journal_lines(), Journal entries, ledger, and trial balance service. (+7 more)

### Community 4 - "Accounting Module"
Cohesion: 0.06
Nodes (74): Account, delete_account(), AccountType, Account, int, str, Account, datetime (+66 more)

### Community 6 - "HR Module"
Cohesion: 0.12
Nodes (14): str, str, str, str, str, str, str, AuditLog (+6 more)

### Community 7 - "PDF Generators"
Cohesion: 0.24
Nodes (13): Account, int, str, Expense, ExpenseStatus, ExpenseService, Expense CRUD service (create, read, update, delete)., Void old transaction and post a corrected balanced entry. (+5 more)
...
Cohesion: 0.19
Nodes (12): BaseModel, Notification, _can_send_notifications(), index(), mark_all_read(), popups(), _query_current_user_notifications(), recent() (+4 more)
...
Cohesion: 0.13
Nodes (19): str, str, int, create(), delete(), edit(), export(), index() (+11 more)
...
Cohesion: 0.25
Nodes (6): str, A single line in the accounting ledger.  Every entry MUST belong to a     Transa, _create_balanced_transaction(), Double-entry Balance Rules, Create a Transaction + LedgerEntry rows atomically.     Raises ValueError if ent, TransactionType
...
Cohesion: 0.08
Nodes (12): Libro Diario, Transaction Void Delete Workflow, Libro Mayor, Project Financial Detail, Financial Reporting Workflow, Financial Reports, int, str (+4 more)
...
Cohesion: 0.24
Nodes (9): str, str, create_invoice_or_quote, _generate_document_number, update_invoice_or_quote, update(), PaymentMethod, Payment (+1 more)

### Community 22 - "Unify Contacts Migration"
Cohesion: 0.15
Nodes (22): str, int, str, str, Leave Request Form, _allowed_file(), create_leave(), create_schedule() (+14 more)

### Community 24 - "Initial Migration"
Cohesion: 0.50
Nodes (3): AuditMiddleware, Manually log a change. Useful if automated listeners are not enough., Company Routes
...
Cohesion: 0.16
Nodes (14): delete_income(), Account, int, str, Transaction, str, Groups one or more paired LedgerEntry rows into an atomic double-entry     journ, Transaction (+6 more)
...
Cohesion: 0.15
Nodes (14): Account, int, bool, float, TransactionType, Return True if total debits == total credits across all entries., Return the transaction amount (sum of debit side)., post_invoice_payment_income() (+6 more)
...
Cohesion: 0.16
Nodes (14): bool, int, str, bool, str, bool, AccountingAttachment, Lowercase file extension without leading dot (e.g. 'pdf', 'jpg'). (+6 more)
...
Cohesion: 0.13
Nodes (17): add_invoice_payment, add_payment(), create(), delete(), edit(), export(), index(), print_invoice() (+9 more)
...
## Knowledge Gaps
- **106 isolated node(s):** `bool`, `bool`, `Company`, `state`, `STATE_KEYS` (+101 more)
...
- **Why does `Flask` connect `Detect Script` to `App Init & Middleware`, `Inventory & Orders Service`, `Accounting Module`, `Community 5`, `Inventory Routes`, `Auth Module`, `Barcode JS`, `Payments Module`, `Drawer UI JS`, `Order Form JS`, `Unify Contacts Migration`, `Models Update Migration`, `Budget Migration`, `Login Migration`, `Tags Migration`, `Community 44`, `Community 95`, `Community 97`, `Community 102`, `Community 104`, `Community 108`, `Community 109`, `Community 110`?**
  _High betweenness centrality (0.135) - this node is a cross-community bridge._
- **Why does `BaseModel` connect `HR Module` to `Core Models`, `Inventory & Orders Service`, `Invoices Service`, `Accounting Module`, `Auth Module`, `Barcode JS`, `Warehouses Service`, `Migrations Core`, `Consolidate Schema Migration`, `Order Form JS`, `Unify Contacts Migration`, `Auto Migration`, `Initial Migration`, `Auto Migration 2`, `Models Update Migration`, `Audit Columns Migration`, `Roles Migration`, `HR Migration`, `Tags Migration`, `Community 43`, `Community 45`, `Community 101`?**
  _High betweenness centrality (0.091) - this node is a cross-community bridge._
- **Why does `datetime` connect `Accounting Module` to `App Init & Middleware`, `Budget Migration`, `Invoices Service`, `Community 100`, `Tags Migration`, `Community 5`, `PDF Generators`, `Inventory Routes`, `Auth Module`, `Detect Script`, `Barcode JS`, `Community 109`, `Community 112`, `Warehouses Service`, `Order Form JS`, `Community 60`?**
...
- **What connects `bool`, `URL segment for company-scoped routes (slug preferred, else numeric id).`, `Internal date / file helpers shared across accounting services.` to the rest of the system?**
