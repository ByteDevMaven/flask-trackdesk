...
## Corpus Check
- 144 files · ~112,697 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 829 nodes · 1829 edges · 51 communities (49 shown, 2 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 194 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2dc4a2a1`
...
- `str` --uses--> `BaseModel`  [INFERRED]
  app/models/report.py → app/models/base.py
...
Cohesion: 0.05
Nodes (37): str, str, str, float, str, str, str, str (+29 more)
...
Cohesion: 0.06
Nodes (47): str, float, str, str, str, int, str, str (+39 more)
...
Cohesion: 0.06
Nodes (16): float, int, str, bool, str, Account, Accounts that normally carry a debit balance vs credit balance., Chart of Accounts entry.      IMPORTANT: Balance is NOT stored here — it is alwa (+8 more)
...
- **Why does `BaseModel` connect `Core Models` to `Invoices Service`, `HR Module`, `PDF Generators`, `Auth Module`, `Users Service`, `Community 46`?**
  _High betweenness centrality (0.112) - this node is a cross-community bridge._
- **Why does `resolve_company()` connect `Inventory Routes` to `Inventory & Orders Service`, `Invoices Service`, `Community 5`, `HR Module`, `Companies Service`, `Warehouses Service`, `Community 53`?**
