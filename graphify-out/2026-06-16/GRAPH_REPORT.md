...
## Corpus Check
- 159 files · ~124,594 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1110 nodes · 2447 edges · 105 communities (90 shown, 15 thin omitted)
- Extraction: 87% EXTRACTED · 13% INFERRED · 0% AMBIGUOUS · INFERRED: 327 edges (avg confidence: 0.54)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ad9617c2`
...
Cohesion: 0.11
Nodes (26): bool, datetime, str, int, str, bool, _create_balanced_transaction(), Double-entry Balance Rules (+18 more)

### Community 4 - "Accounting Module"
Cohesion: 0.09
Nodes (49): Account, int, str, int, int, str, str, Company (+41 more)
...
Cohesion: 0.20
Nodes (16): int, str, Account, Expense, int, str, ExpenseStatus, TransactionType (+8 more)
...
Cohesion: 0.10
Nodes (32): Helper to resolve a company from a route parameter that could be an integer ID o, resolve_company(), schedule_events(), schedules(), view_deviation(), view_leave(), api_adjust_stock(), api_bulk_delete() (+24 more)
...
Cohesion: 0.16
Nodes (7): bool, str, Authenticate a user by email and password.         Returns (user, error_message), Determine safe redirect URL after login., Generate and send a password reset token if user exists., Validate token and reset password., Sends an error notification to the configured admin email.
...
Cohesion: 0.26
Nodes (8): Account, int, str, Account, Accounts that normally carry a debit balance vs credit balance., Chart of Accounts entry.      IMPORTANT: Balance is NOT stored here — it is alwa, AccountType, Account CRUD and chart of accounts generation.

### Community 21 - "Order Form JS"
Cohesion: 0.11
Nodes (21): _generate_document_number, add_invoice_payment, add_payment(), create(), delete(), edit(), export(), index() (+13 more)
...
Cohesion: 0.18
Nodes (15): float, str, _allowed_file(), create_leave(), create_schedule(), delete_employee(), delete_leave(), delete_schedule() (+7 more)
...
Cohesion: 0.21
Nodes (12): Account, datetime, float, int, float, int, DashboardService, ContactType (+4 more)
...
Cohesion: 0.14
Nodes (12): bool, str, bool, str, Contact, Validate phone format (basic: digits, +, -, spaces)., Return True if the user's role carries *permission_name*.         Superadmins (r, Shortcut — True when the user's role is 'superadmin' (platform admin). (+4 more)

### Community 34 - "Accounting Migration"
Cohesion: 0.47
Nodes (6): User Role And Company Assignment, User Form Drawer, User Status Toggle Workflow, User Administration List Screen, User Danger Zone, User Profile Screen
...
Cohesion: 0.29
Nodes (5): int, str, str, Auto-generate a SKU from the item name and its DB id.                  Example:, str
...
Cohesion: 0.12
Nodes (16): str, float, str, create_invoice_or_quote, update_invoice_or_quote, Document, Calculate subtotal from document items (before tax). Cached., Calculate tax amount based on subtotal and company tax rate. Cached. (+8 more)
...
- **Why does `Flask` connect `Community 97` to `Inventory & Orders Service`, `Invoices Service`, `Accounting Module`, `Community 5`, `Inventory Routes`, `Auth Module`, `Barcode JS`, `Payments Module`, `Migrations Core`, `Drawer UI JS`, `Order Form JS`, `Auto Migration`, `Initial Migration`, `Auto Migration 2`, `Models Update Migration`, `Audit Columns Migration`, `Login Migration`, `Tags Migration`, `Detect Script`, `Community 43`, `Community 44`, `Community 95`, `Community 96`, `Community 99`, `Community 101`?**
  _High betweenness centrality (0.136) - this node is a cross-community bridge._
- **Why does `BaseModel` connect `HR Module` to `Inventory & Orders Service`, `Invoices Service`, `Accounting Module`, `Auth Module`, `Barcode JS`, `Warehouses Service`, `Consolidate Schema Migration`, `Unify Contacts Migration`, `Auto Migration`, `Initial Migration`, `Auto Migration 2`, `Warehouses Migration`, `Budget Migration`, `HR Migration`, `Tags Migration`, `Modals UI JS`, `Community 45`, `Community 50`, `Community 54`, `Community 101`?**
  _High betweenness centrality (0.088) - this node is a cross-community bridge._
- **Why does `ProjectService` connect `Accounting Module` to `App Init & Middleware`, `Community 97`, `HR Migration`, `Invoices Service`, `Community 101`, `HR Module`, `Community 43`, `Community 46`, `Consolidate Schema Migration`, `Community 54`, `Audit Columns Migration`?**
...
- **What connects `Return (workbook, filename) for all invoice rows matching the active filters.`, `RBAC Middleware =============== Plugged into the app via ``init_rbac(app)`` in ``, `Register the RBAC ``before_request`` hook on *app*.` to the rest of the system?**
